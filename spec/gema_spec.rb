...
RSpec.describe Gema do
  ...
  describe Grupo_alimentos do
	...
	before :each do
		...
		@grupos = Lista.new( [ "Huevos, lácteos y helados", "Carnes y derivados", "Pescados y mariscos", "ALimentos grasos", "Alimentos ricos en carbohidratos", "Verduras y Hortalizas", "Frutas" ] )
		...
		@alimentos = Lista.new( [ @gp1, @gp2, @gp3, @gp4, @gp5, @gp6 ] )

		@grupos_alimentos = Grupos_alimentos.new(@grupos, @alimentos)
	end
